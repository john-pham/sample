...
export class SuppliersComponent implements OnInit, OnDestroy {
    ...
    private getFromServer() {
        ...
        //
        var disp = this.localService.search(this.filterName, this.filterValue, 2, this.page.pageNumber, this.page.size).subscribe(
    ...
    private getGrpSupplier() {
        this.loadingIndicator = true;
        var disp = this.localService.getGrpSupplier(2).subscribe(
