...
@Component({
    selector: 'suppliercus',
    templateUrl: './suppliercus.component.html',
    styleUrls: ['./suppliercus.component.css'],
    animations: [fadeInOut]
})

export class SupplierCusComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    private getFromServer() {
        ...
        //
        var disp = this.localService.search(this.filterName, this.filterValue, 1, this.page.pageNumber, this.page.size).subscribe(
    ...
    private getGrpSupplier() {
        this.loadingIndicator = true;
        var disp = this.localService.getGrpSupplier(1).subscribe(
