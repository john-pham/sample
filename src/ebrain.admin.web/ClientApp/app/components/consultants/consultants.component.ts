...
export class ConsultantsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            { prop: "code", name: gT('label.consultant.Code'), width: 100, headerTemplate: this.statusHeaderTemplate, cellTemplate: this.statusTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false },
            { prop: 'name', name: gT('label.consultant.Name'), cellTemplate: this.nameTemplate },
            { prop: 'note', name: gT('label.consultant.Note'), cellTemplate: this.descriptionTemplate },
