...
@Component({
    selector: 'paymentlistfalse',
    templateUrl: './paymentlistfalse.component.html',
    styleUrls: ['./paymentlistfalse.component.css'],
    animations: [fadeInOut]
})

export class PaymentListFalseComponent implements OnInit, OnDestroy {
