...
export class StocksComponent implements OnInit, OnDestroy {
    ...
    addStock(template: TemplateRef<any>) {
    ...
    private deleteSuccessHelper(row: Stock) {
        this.getFromServer();
        this.alertService.showMessage("Success", `Stock \"${row.Name}\" was deleted successfully`, MessageSeverity.success);
    ...
    private onDataLoadSuccessful(list: Stock[]) {
        this.rows = list;
        this.alertService.stopLoadingMessage();
    ...
    private saveSuccessHelper(user?: Stock) {
        this.alertService.stopLoadingMessage();
        //this.resetForm();
        this.modalRef.hide();
        //
