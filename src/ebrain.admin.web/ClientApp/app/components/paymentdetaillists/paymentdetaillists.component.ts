...
export class PaymentDetailListsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { prop: 'ioNumber', name: gT('label.paymentlist.IONumber'), cellTemplate: this.nameTemplate },
            ...
            { prop: '', width: 80, cellTemplate: this.actionsTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false }
        ];
