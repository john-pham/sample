...
@Component({
    selector: 'iostudentlistinput',
    templateUrl: './iostudentlistinput.component.html',
    styleUrls: ['./iostudentlistinput.component.css'],
    animations: [fadeInOut]
})

export class IOStudenListInputComponent implements OnInit, OnDestroy {
