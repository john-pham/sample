...
@Component({
    selector: 'purdetails',
    templateUrl: './purdetails.component.html',
    styleUrls: ['./purdetails.component.css'],
    animations: [fadeInOut]
})

export class PurDetailsComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { headerClass: "text-center", prop: 'materialCode', name: gT('label.purchaselist.MaterialCode'), cellTemplate: this.nameTemplate },
            { headerClass: "text-center", prop: 'materialName', name: gT('label.purchaselist.MaterialName'), cellTemplate: this.nameTemplate },
    ...
    private getFromServer() {
        ...
        //
        var disp = this.localService.getpurchaseorderdetails(this.filterName, this.filterValue, this.fromDate, this.toDate, this.page.pageNumber, this.page.size).subscribe(
    ...
    private getReport(template: TemplateRef<any>) {
        this.localService.retportpurchaseorderdetails(this.filterName, this.filterValue, this.fromDate, this.toDate, this.page.pageNumber, this.page.size).subscribe(
            resulted => {
                this.chart = resulted;
