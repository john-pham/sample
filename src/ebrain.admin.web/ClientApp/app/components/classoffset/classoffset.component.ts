...
@Component({
    ...
    templateUrl: './classoffset.component.html',
    styleUrls: ['./classoffset.component.css'],
    animations: [fadeInOut]
})

export class ClassOffsetComponent implements OnInit, OnDestroy {
