...
@Component({
    selector: 'studentmodules',
    templateUrl: './studentmodules.component.html',
    styleUrls: ['./studentmodules.component.css'],
...
export class StudentModuleComponent implements OnInit, OnDestroy {
    ...
    readonly potentialTab = "potential";
    readonly learningTab = "learning";
    readonly endClassTab = "endClass";
    readonly pendingTab = "pending";
    readonly markTab = "mark";
    readonly deptTab = "dept";

    activeTab: string = this.potentialTab;
    isPotentialActive = true;
    isLearningActive = false;
    isEndClassActive = false;
    ...
    onShowTab(event) {
        ...
        switch (this.activeTab) {
            case this.potentialTab:
                this.isPotentialActive = true;
                break;
            case this.learningTab:
                this.isLearningActive = true;
                break;
            case this.endClassTab:
                this.isEndClassActive = true;
                break;
