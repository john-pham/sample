...
export class TypeMaterialsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            { prop: "code", name: gT('label.typeMaterial.Code'), width: 100, headerTemplate: this.statusHeaderTemplate, cellTemplate: this.statusTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false },
            { prop: 'name', name: gT('label.typeMaterial.Name'), cellTemplate: this.nameTemplate },
            { prop: 'note', name: gT('label.typeMaterial.Note'), cellTemplate: this.descriptionTemplate },
