...
@Component({
    selector: 'mn-humans',
    templateUrl: './mn-humans.component.html',
    styleUrls: ['./mn-humans.component.css'],
    animations: [fadeInOut]
})

export class mn_humansComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    constructor(private alertService: AlertService, private translationService: AppTranslationService, private localService: mn_humansService) {
    }
