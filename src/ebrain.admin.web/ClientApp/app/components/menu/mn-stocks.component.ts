...
@Component({
    selector: 'mn-stocks',
    templateUrl: './mn-stocks.component.html',
    styleUrls: ['./mn-stocks.component.css'],
    animations: [fadeInOut]
})

export class mn_stocksComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    constructor(private alertService: AlertService, private translationService: AppTranslationService, private localService: mn_stocksService) {
    }
