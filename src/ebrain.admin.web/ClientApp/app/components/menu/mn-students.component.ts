...
@Component({
    selector: 'mn-students',
    templateUrl: './mn-students.component.html',
    styleUrls: ['./mn-students.component.css'],
    animations: [fadeInOut]
})

export class mn_studentsComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    constructor(private alertService: AlertService, private translationService: AppTranslationService, private localService: mn_studentsService) {
    }
