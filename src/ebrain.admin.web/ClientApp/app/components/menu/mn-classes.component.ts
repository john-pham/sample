...
@Component({
    selector: 'mn-classes',
    templateUrl: './mn-classes.component.html',
    styleUrls: ['./mn-classes.component.css'],
    animations: [fadeInOut]
})

export class mn_classesComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    constructor(private alertService: AlertService, private translationService: AppTranslationService, private localService: mn_classesService) {
    }
