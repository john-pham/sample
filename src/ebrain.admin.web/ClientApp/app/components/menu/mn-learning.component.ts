...
@Component({
    selector: 'mn-learning',
    templateUrl: './mn-learning.component.html',
    styleUrls: ['./mn-learning.component.css'],
    animations: [fadeInOut]
})

export class mn_learningComponent implements OnInit, OnDestroy {
    rows = [];
    columns = [];
    ...
    constructor(private alertService: AlertService, private translationService: AppTranslationService, private localService: mn_learningService) {
    }
