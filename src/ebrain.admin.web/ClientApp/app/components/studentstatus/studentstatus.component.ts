...
export class StudentstatusComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            { prop: "code", name: gT('label.studentstatus.Code'), width: 100, headerTemplate: this.statusHeaderTemplate, cellTemplate: this.statusTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false },
            { prop: 'name', name: gT('label.studentstatus.Name'), cellTemplate: this.nameTemplate },
            { prop: 'note', name: gT('label.studentstatus.Note'), cellTemplate: this.descriptionTemplate },
