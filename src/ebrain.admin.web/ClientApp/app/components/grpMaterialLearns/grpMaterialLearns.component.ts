...
export class GrpMaterialLearnsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            { prop: "code", name: gT('label.grpMaterialLearn.Code'), width: 100, headerTemplate: this.statusHeaderTemplate, cellTemplate: this.statusTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false },
            { prop: 'name', name: gT('label.grpMaterialLearn.Name'), cellTemplate: this.nameTemplate },
            { prop: 'typeMaterialName', name: gT('label.grpMaterialLearn.GrpMaterialName'), cellTemplate: this.descriptionTemplate },
            { prop: 'note', name: gT('label.grpMaterialLearn.Note'), cellTemplate: this.descriptionTemplate },
