...
@Injectable()
export class TypeMaterialLearnsEndpoint extends EndpointFactory {

    private readonly _serviceUrl: string = "/api/typeMaterialLearns";
    ...
    getalltype(): Observable<Response> {

        let url = this.getUrl('getalltypelearn?hash_id=' + Math.random());
        ...
        return this.http.get(url, this.getAuthHeader())
            ...
            .catch(error => {
                return this.handleError(error, () => this.getalltype());
            });
    }
